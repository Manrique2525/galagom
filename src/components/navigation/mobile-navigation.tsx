  ...
  return <div className="lg:hidden">
    ...
    {isOpen && <nav id="mobile-menu" className="absolute inset-x-0 top-20 z-40 border-b border-border bg-white px-5 py-5 shadow-[var(--shadow-soft)]" aria-label="Navegación móvil">
      <div className="mx-auto flex max-w-[var(--container-width)] flex-col gap-1">
        ...
        <Link className="mt-2 rounded-sm bg-primary px-3 py-3 text-center text-sm font-bold text-white hover:bg-primary-soft focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary" href="#contacto" onClick={() => setIsOpen(false)}>Cotizar flete</Link>
      </div>
    </nav>}
  </div>;
}
