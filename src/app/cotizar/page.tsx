...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: "/cotizar", title: "Cotizar Flete en Cancún | GALAGOM", description: "Solicita información sobre transporte, almacenaje y logística en Cancún y Quintana Roo." },
  twitter: { card: "summary_large_image", title: "Cotizar Flete en Cancún | GALAGOM", description: "Solicita información sobre transporte, almacenaje y logística en Cancún y Quintana Roo." },
};
