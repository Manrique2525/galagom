...
export const services: Service[] = [
  { id: "islas", index: "01", title: "Fletes Isla Mujeres y Cozumel", description: "Servicio de carga y fletes hacia Isla Mujeres, Cozumel y Holbox, además de cobertura logística en Quintana Roo.", icon: "route", image: "/images/temporary/logistics-hero.webp", imageAlt: "Camión de carga frente a un almacén" },
