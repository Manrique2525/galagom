...
export const services: Service[] = [
  { id: "islas", index: "01", title: "Fletes Isla Mujeres y Cozumel", description: "Servicio en Quintana Roo, incluyendo Holbox, Isla Mujeres y Cozumel.", icon: "route", image: "/images/temporary/freight-truck.webp", imageAlt: "Camión de carga en una operación logística" },
